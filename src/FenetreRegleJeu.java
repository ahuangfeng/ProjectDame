...
public class FenetreRegleJeu extends JFrame {
    ...
    public FenetreRegleJeu() {
        ...
        //création du JLabel
        this.regle = new JLabel("<html>Objectif : eliminer tous les pions de son adversaire. <br> Regles du jeu : Le jeu se fait sur un plateau de 100 cases (alterne noir et blanc). Les pions se deplacent en diagonale (avant et arriere) d une seule case. Pour eliminer un pion de l adversaire, il faut se trouver a cote du pion, en diagonale et pouvoir sauter au dessus de lui pour pouvoir lui prendre son pion. <br> Option Dame : si un pion arrive sur la premiere ligne de l adversaire, le pion devient alors une dame. Ce nouveau pion peut alors se deplacer, toujours en diagonale, mais en arriere. Pour eliminer des pions, il doit en revanche pouvoir aussi sauter au-dessus d eux.</html>");
